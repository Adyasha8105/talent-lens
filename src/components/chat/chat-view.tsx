...
import { Job, Message, Criterion, Candidate } from "@/lib/types";
import { Button } from "@/components/ui";
import { parseUserInput, generatePrompt } from "@/lib/utils";
import { quickSuggestions, mockCandidates } from "@/lib/mock-data";
import { ChatMessage, TypingIndicator } from "./chat-message";
import { PromptPanel } from "./prompt-panel";
import { SampleResultsDrawer } from "./sample-results-drawer";
...
export function ChatView({ job, onBack, onRunComplete }: ChatViewProps) {
